...
//    private final VerifiableCredentialValidationService verifiableCredentialValidationService;
	private final DcpIdentityHolderService holderService;
	private final DcpIdentityVerifierService verifierService;
...
//    }
    public DcpIdentityService(DcpIdentityHolderService holderService, DcpIdentityVerifierService verifierService) {
...
//    }
    @Override
    public Result<TokenRepresentation> obtainClientCredentials(String participantContextId, TokenParameters parameters) {    
        return holderService.obtainClientCredentials(participantContextId, parameters);
    }
...
//    }
    @Override
    public Result<ClaimToken> verifyJwtToken(String participantContextId, TokenRepresentation tokenRepresentation, VerificationContext context) {  
	    return verifierService.verifyJwtToken(participantContextId, tokenRepresentation, context);
    }
